 ...
 xhr.onreadystatechange = function() {
    if (xhr.readyState === XMLHttpRequest.DONE) {
        if (xhr.status === 200) {
            ...
            const detailItemCrite = detailElement.querySelector('.detail__item__footer__stats-crite');
            ...
            if (selectedItem.crite != 0) {
                detailItemCrite.textContent = "Crite: " + selectedItem.crite + "%"; 
            }
